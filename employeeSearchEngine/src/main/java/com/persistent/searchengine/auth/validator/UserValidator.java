package com.persistent.searchengine.auth.validator;
...
public class UserValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "projectGrade", "NotEmpty");
        
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "projectName", "NotEmpty");
        if (user.getProjectName().length() < 6 || user.getProjectName().length() > 32) {
            errors.rejectValue("projectName", "Size.userForm.projectName");
        }
